          ...
          <div className="flex items-center gap-4">
            <Sheet>
              ...
              <SheetContent side="right" className="w-full flex flex-col p-0 border-none bg-white">
                <div className="flex flex-col gap-6 mt-12 px-6 flex-1" dir="rtl">
                  <Link href="/" className={`text-2xl font-black uppercase tracking-tighter transition-all hover:translate-x-1 ${location === '/' ? 'text-black' : 'text-muted-foreground'}`}>الرئيسية</Link>
                  <Link href="/products" className={`text-2xl font-black uppercase tracking-tighter transition-all hover:translate-x-1 ${location === '/products' ? 'text-black' : 'text-muted-foreground'}`}>المتجر</Link>
                  
                  {user && (
                    <>
                      <Link href="/dashboard" className="text-2xl font-black uppercase tracking-tighter transition-all hover:translate-x-1 text-black">حسابي</Link>
                      <Link href="/orders" className="text-2xl font-black uppercase tracking-tighter transition-all hover:translate-x-1 text-black">طلباتي</Link>
                      {user.role === 'admin' && (
                        <Link href="/admin" className="text-2xl font-black uppercase tracking-tighter transition-all hover:translate-x-1 text-primary">لوحة التحكم</Link>
                      )}
                    </>
                  )}
                </div>

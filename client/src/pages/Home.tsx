  ...
  return (
    <Layout>
      <div className="bg-background transition-colors duration-500">
        ...
        <section className="relative min-h-[70vh] sm:min-h-screen lg:min-h-[90vh] flex items-center overflow-hidden bg-background">
          <div className="container relative z-10 grid lg:grid-cols-2 gap-8 items-center px-4 py-6 sm:py-12 lg:py-20">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[0.9] mb-4 sm:mb-8 text-foreground tracking-tighter text-balance">
                <img src={logoImg} alt="Gen M & Z Logo" className="h-12 sm:h-20 md:h-24 lg:h-32 mb-4 dark:invert" />
                ...
                <Editable blockKey="home-hero-cta" defaultContent={language === 'ar' ? 'اكتشف المجموعة' : t('discoverCollection')}>
                  {(content) => (
                    <Link href="/products" className="w-full sm:w-auto">
                      <Button size="lg" className="w-full sm:w-auto px-6 sm:px-10 py-6 sm:py-8 text-xs sm:text-sm font-bold uppercase tracking-[0.2em] rounded-none shadow-2xl hover-elevate transition-all bg-primary text-primary-foreground border-none active-elevate-2">
          ...
          <div className="container px-4">
            <div className={`flex flex-col md:flex-row justify-between items-end gap-4 md:gap-8 mb-8 md:mb-20 ${language === 'ar' ? 'text-right' : 'text-left'}`}>
              <div className="max-w-2xl w-full">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-black uppercase tracking-tighter mb-2 md:mb-6 leading-tight text-foreground">{t('exclusivePicks')}</h2>
              ...
              <Link href="/products" className="w-full md:w-auto">
                <Button size="lg" className="w-full md:w-auto rounded-none border-primary font-bold uppercase tracking-widest text-[9px] md:text-xs h-10 md:h-14 px-6 md:px-10 group bg-primary text-primary-foreground hover:bg-primary/80 transition-all">
                  {t('viewAllProducts')}
            ...
            {isLoading ? (
              ...
              <div className="text-center py-24">
                ...
                <Link href="/products">
                  <Button size="lg" className="bg-primary text-primary-foreground">{language === 'ar' ? 'استكشف المتجر' : 'Explore Store'}</Button>
                </Link>
              </div>
            )}
          </div>
        ...
        <section className="relative py-12 sm:py-32 bg-background overflow-hidden">
          <div className="container px-4">
            <div className={`text-center max-w-3xl mx-auto mb-12 sm:mb-24 ${language === 'ar' ? 'text-right' : 'text-left'}`}>
              ...
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter mb-4 sm:mb-6 text-foreground">{language === 'ar' ? 'تشكيلة الهوديز الجديدة' : 'New Hoodies Collection'}</h2>
            ...
            <div className="relative w-full max-w-5xl mx-auto">
              {/* Carousel Container */}
              <div className="relative h-[300px] sm:h-[500px] md:h-[700px] bg-muted rounded-2xl overflow-hidden shadow-2xl">
                <AnimatePresence mode="wait">
                  {/* Current Image */}
                  <motion.img
              ...
              <div className="flex justify-between items-center mt-8 px-4">
                <motion.button
                  ...
                  className="p-3 rounded-full bg-primary text-primary-foreground hover-elevate transition-all"

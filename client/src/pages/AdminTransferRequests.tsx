        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <Input placeholder="بحث عن طلب نقل..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="max-w-sm" />
            </div>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {filteredTransfers.map((transfer: any) => (
                    <TableRow key={transfer.id}>
                      ...
                      <TableCell>
                        <Badge variant="secondary">{transfer.status || "قيد المعالجة"}</Badge>
                      </TableCell>
                      <TableCell>

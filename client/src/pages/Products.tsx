...
export default function Products() {
  ...
  return (
    <Layout>
      ...
      />
      <div className="container py-12 sm:py-16 md:py-20 lg:py-24" dir={language === 'ar' ? 'rtl' : 'ltr'}>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-muted-foreground animate-pulse">{language === 'ar' ? 'جاري تحميل المنتجات...' : 'Loading products...'}</p>
          </div>
          ...
          <div className="text-center py-20 sm:py-24 md:py-32 flex flex-col items-center">
            <PackageSearch className="h-16 w-16 text-muted-foreground/20 mb-6" />
